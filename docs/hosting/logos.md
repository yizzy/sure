...
bloom has integration with the [Brand Fetch Logo Link](https://brandfetch.com/developers/logo-api) service to provide logos for accounts, merchants and securities.
...
Once you enter the Client ID into the bloom settings under the `Self-Hosting` section, logos from Brand Fetch integration will be enabled.
